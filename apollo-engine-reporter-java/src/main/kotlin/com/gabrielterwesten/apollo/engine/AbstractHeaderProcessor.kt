...
abstract class AbstractHeaderProcessor(
        ...
        /**
         * The [HeaderGroup]s to process. [HeaderGroup]s not in this set will be passed through
         * as is. If `null` is given all [HeaderGroup]s will be processed.
         */
    ...
    override fun process(input: TraceInput): TraceInput = input.httpTrace?.let {
        input.copy(httpTrace = it.copy(
    ...
    private fun processHeaders(headers: Map<String, List<String>>?,
                               headerGroup: HeaderGroup): Map<String, List<String>>? =
